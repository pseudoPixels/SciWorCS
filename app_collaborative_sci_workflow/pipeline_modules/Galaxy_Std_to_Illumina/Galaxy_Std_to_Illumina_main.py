...
with open(illumina_fastq_file, "w") as f:
	subprocess.Popen(["/usr/bin/perl", "/home/ubuntu/Webpage/app_collaborative_sci_workflow/fq_all2std.pl", "std2illumina", std_fastq_file], stdout=f).communicate()
