...
df_class.plot(kind='bar',stacked=True, figsize=(5,3), title="Survived/Died by Class").get_figure().savefig("/home/ubuntu/Webpage/app_collaborative_sci_workflow/static/img/" + "_plot.png")



with open(feature_categories_by_lables+".html", "w+") as thisModuleOutput:
    thisModuleOutput.write("<HTML><body>")
    thisModuleOutput.write("<img src='http://p2irc-cloud.usask.ca/app_collaborative_sci_workflow/static/img/_plot.png" + "'/>")
