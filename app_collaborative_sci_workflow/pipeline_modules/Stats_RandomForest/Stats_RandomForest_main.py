...
classifier = RandomForestClassifier(n_estimators = num_estimators, criterion = 'entropy', random_state = 0)
...
with open(RandomForest_classification_stats, "w+") as thisModuleOutput:
    thisModuleOutput.write("Random Forest:\n========================================\n")
