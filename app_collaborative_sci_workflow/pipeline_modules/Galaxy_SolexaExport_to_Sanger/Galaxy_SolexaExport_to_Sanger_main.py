...
with open(sanger_file, "w") as f:
	subprocess.Popen(["/usr/bin/perl", "/home/ubuntu/Webpage/app_collaborative_sci_workflow/fq_all2std.pl", "export2std", solexa_export_file], stdout=f).communicate()
