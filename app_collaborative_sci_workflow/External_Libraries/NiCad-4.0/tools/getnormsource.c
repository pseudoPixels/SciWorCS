...
typedef	TLchar	linetable___x131[720000001];
static linetable___x131	linetable_lineText;
static TLint4	linetable_lineTextSize;
typedef	TLint4	linetable___x134[14400000];
...
TLstring	__x81;
{
	...
	TLSTRASS(255, line, __x155);
    };
    {
	TLSTRASS(255, __x81, line);
	return;
    };
    /* NOTREACHED */
}
...
{
    {
	TLSTRASS(255, __x92, (* (TLstring *) &linetable_lineText[(linetable_lineTable[lineIndex]) - 1]));
	return;
    };
    /* NOTREACHED */
}
...
typedef	struct PC	__x160[7200000];
static __x160	pcs;
static TLint4	npcs;
typedef	linetable_LN	__x161[120000000];
static __x161	lines;
...
static void getprogramarguments () {
	...
	TLSTRASS(255, pcfile, __x165);
    };
    {
	TLstring	__x166;
	TL_TLI_TLIFA((TLint4) 2, __x166);
	TLSTRASS(255, ccfile, __x166);
    };
    {
	TLstring	__x167;
	TL_TLI_TLIFA((TLint4) 3, __x167);
	TLSTRASS(255, rccfile, __x167);
    };
}
...
static void resolvepcsources () {
	...
	for (i = 1; i <= 999999999; i++) {
		...
		TLBIND((*pc), struct PC);
		{
		    ...
		    TLSTRASS(255, sourceheader, __x168);
		};
