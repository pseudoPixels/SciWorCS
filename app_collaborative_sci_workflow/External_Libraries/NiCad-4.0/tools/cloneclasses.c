...
typedef	TLchar	linetable___x165[72000001];
static linetable___x165	linetable_lineText;
static TLint4	linetable_lineTextSize;
typedef	TLint4	linetable___x168[14400000];
...
TLstring	__x78;
{
	...
	TLSTRASS(255, line, __x189);
    };
    {
	TLSTRASS(255, __x78, line);
	return;
    };
    /* NOTREACHED */
}
...
TLstring	line;
{
	...
	if ((linetable_lineTable[lineIndex]) == 0) {
	    if (((linetable_lineTextSize + linelength) + 1) > 72000000) {
		TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
		TL_TLI_TLIPS ((TLint4) 0, "*** Error: too much total unique line text ( > ", (TLint2) 0);
		TL_TLI_TLIPI ((TLint4) 0, (TLint4) 72000000, (TLint2) 0);
...
typedef	struct CP	__x194[48000000];
static __x194	pairs;
static TLint4	npairs;
typedef	TLint4	__x195[7200000];
...
static void readclonepairs () {
	...
	TL_TLI_TLIPI ((TLint4) 0, (TLint4) 24000000, (TLint2) 0);
	TL_TLI_TLIPS ((TLint4) 0, ")", (TLint2) 0);
	TL_TLI_TLIPK ((TLint2) 0);
    };
...
typedef	struct CL	__x203[2400000];
static __x203	clusters;
static TLint4	nclusters;
typedef	TLint4	__x204[24000000];
