...
//Selecting this tool from left menu: append and make this papel visible
...
//Settings Hide or Show
$(".settings_hideshow_binThreshold").live("click", function () {
   
    $(this).siblings(".settings_module").toggle(500);
});
...
//=====================================================================================================
//design_pipelines_imgReg --- STARTS ----
//=====================================================================================================

//RUN COMPLETE PIPELINE... TEMPORARY... SITS BESIDE ONLY IMG SEG
$("#runPipeline").live('click', function () {
    //alert('Looks like you want to run the whole pipeline....');

    $(".design_pipelines_imgReg_btn").trigger("click");
    setTimeout(function () {
        $(".design_pipelines_imgSeg_btn").trigger("click");
    }, 9000);
...
//clicking execute btn: process the input image and display the output
$(".design_pipelines_imgReg_btn").live('click', function () {         //<==========================CHANGE HERE
    //alert($(this).siblings(".moduleName").val());
    var $thisButton = $(this);
    $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#FF8C00');
    $thisButton.parent().parent().siblings(".centered").find("span").text('Status: Processing...');
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: "/img_reg",                  //<==========================CHANGE HERE
        data: $(this).siblings(".design_pipelines_imgReg_form").serialize(),   //<==========================CHANGE HERE
        success: function (option) {
...
//Selecting this tool from left menu: make this papel visible and other panels invisible
$("#design_pipelines_menu_imgReg_id").click(function () {                     //<====================CHANGE HERE
    $(".img_tools_panel_class").hide();
    ...
    $("#img_processing_screen").append('<div class ="row mt " > <!--CHANGE IN THIS LINE--> ' +
                                               ...
                                               ' <div class ="col-md-4 col-sm-4 mb" style="height:200px;">' +
                                                        ...
                                                        '  <div class ="col-sm-6 col-xs-6 goleft">' +
                                                                ...
                                                                ' <select  id="temp_pipeline_output_select" >' +
                                                                                    ...
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream4.png" >Pipeline Stream #4</option>' +
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream5.png" >Pipeline Stream #5</option>' +
                                                                                      '    <option value="static/reg/OUT_IMG_0_1.jpg" >Reference Image</option>' +
                                                                                      '    <option value="static/reg/output/1.png">static/reg/output/1.png</option>' +
                                                                                      '    <option value="static/img/plant_sideview.png">Plant Side View</option>' +
                                                                                    '</select>' +
                                                                ' </p>' +
                                                        '  </div>' +
                                    ...
                                    '  <div class ="col-md-4 col-sm-4 mb">' +
                                                '<div class ="white-panel pn">' +
                                                        '<div class ="white-header" style="background-color:#C0CDDC;">' +
                                                                    ' <h5 style="color:#000000;font-weight:bold;" >Image Registration</h5>                                             <!-- CHANGE IN THIS LINE -->' +
                                                                    '<span style="color:#000000;font-weight:bold;">' +
                                                                   '<form action="" method="POST" class="design_pipelines_imgReg_form">                                             <!--CHANGE IN THIS LINE--> ' +
                                                                                    'Input Stream Dir:' +
                                                                                    ' <select  class="moduleName" name="image_location">' +
                                                                                     '    <option value="static/reg/input" selected>static/reg/input/</option>' +
                                                                                    '     <option value="static/reg/output" >static/reg/output</option>' +
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream3.png" >Pipeline Stream #3</option>' +
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream4.png" >Pipeline Stream #4</option>' +
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream5.png" >Pipeline Stream #5</option>' +
                                                                                      '    <option value="static/img/1.jpg" >Plant Leaf</option>' +
                                                                                  ...
                                                                                  '  <select  name="reference_img">' +
                                                                                    ...
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream5.png" >Pipeline Stream #5</option>' +
                                                                                      '    <option value="static/img/1.jpg" >Plant Leaf</option>' +
                                                                                      '    <option value="static/reg/input/1.png">Reference Image</option>' +
                                                                                      '    <option value="static/img/plant_sideview.png">Plant Side View</option>' +
                                                                                   ' </select><br/>' +
                                                                    ...
                                                                    '</form>' +
                                                                    '<br/>' +
                                                                    '<button type="button"   style="float:right;margin-right:20px;margin-top:10px;" class="design_pipelines_imgReg_btn runnable">Run</button></span>       <!-- CHANGE IN THIS LINE -->' +
                                                            '</div>' +
                                                            '<div class ="row">' +
                                                                    '<div class ="col-sm-6 col-xs-6 goleft">' +
                                                                            '   <p> </p>' +
                                ...
                                '  <div class ="col-md-4 mb" style="">' +
                                            '<div class ="white-panel pn">' +
                                                    '<div class ="white-header">' +
                                                        '<h5 style="color:#000000;font-weight:bold;">Run Pipeline</h5>' +
                                                    '</div>' +
                                                    ' <div class ="row">' +
                                                            '<div class ="col-sm-6 col-xs-6 goleft">' +
                                                                    '<p> </p>' +
                                                    ...
                                                    '</div>' +
                                                    '<div class ="centered">' +
                                                            '<Button id="runPipeline" class="myButton">Run Complete Pipeline</Button><!--CHANGE IN THIS LINE-->' +
                                                    '</div>' +
                                            '</div>' +
                                        '</div><!-- /col-md-4 -->' +
                                        '<br/>' +
    ...
    //=====================================================================================================
    //design_pipelines_imgSeg --- STARTS ----
    //=====================================================================================================

    //clicking execute btn: process the input image and display the output
$(".design_pipelines_imgSeg_btn").live('click', function () {         //<==========================CHANGE HERE
    //alert($(this).siblings(".moduleName").val());
    var $thisButton = $(this);
    $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#FF8C00');
    $thisButton.parent().parent().siblings(".centered").find("span").text('Status: Processing...');
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: "/img_seg",                  //<==========================CHANGE HERE
        data: $(this).siblings(".design_pipelines_imgSeg_form").serialize(),   //<==========================CHANGE HERE
        success: function (option) {
            //alert(option);
            setTimeout(function () {
                $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#00FF00');
...
$(".streamSelector").live("change", function () {
    ...
    //Selecting this tool from left menu: make this papel visible and other panels invisible
$("#design_pipelines_menu_imgSeg_id").click(function () {                     //<====================CHANGE HERE
    $(".img_tools_panel_class").hide();
    ...
    $("#img_processing_screen").append('<div class ="row mt " > <!--CHANGE IN THIS LINE--> ' +
                                    ...
                                    '  <div class ="col-md-4 col-sm-4 mb">' +
                                                '<div class ="white-panel pn">' +
                                                        '<div class ="white-header" style="background-color:#C0CDDC;">' +
                                                                    ' <h5 style="color:#000000;font-weight:bold;" >Plot Segmentation</h5>                                             <!-- CHANGE IN THIS LINE -->' +
                                                                    '<span style="color:#000000;font-weight:bold;">' +
                                                                   '<form action="" method="POST" class="design_pipelines_imgSeg_form">                                             <!--CHANGE IN THIS LINE--> ' +
                                                                                    'Input Stream:' +
                                                                                    ' <select  class="moduleName" name="image_location">' +
                                                                                     '     <option value="static/assets/img_outputs/pipelines/stream1.png" selected>Pipeline Stream #1</option>' +
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream2.png" >Pipeline Stream #2</option>' +
                                                                                    ...
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream5.png" >Pipeline Stream #5</option>' +
                                                                                      '    <option value="static/reg/output/1.png" >static/reg/output/1.png</option>' +
                                                                                      '    <option value="static/reg/output/2.png" >static/reg/output/2.png</option>' +
                                                                                      '    <option value="static/reg/output/3.png" >static/reg/output/3.png</option>' +
                                                                                    '</select><br/>' +
                                                                                   ...
                                                                                   ' <select  class="design_pipelines_imgMasking_imgBucket_output_select streamSelector" name="img_output_location">' +
                                                                                    ...
                                                                                    ' <option value="static/assets/img_outputs/output.png">Old</option>' +
                                                                                    '</select><hr/>' +
                                                                                    'xOffset : <input  type="text" size="3" value="20" name="xOffset"/>' +
                                                                                    'yOffset : <input  type="text" size="4" value="400" name="yOffset"/>' +
                                                                                    'Blocks : <input  type="text" size="4" value="5" name="blocks"/><br/>' +
                                                                                    'Plots/Blocks : <input  type="text" size="2" value="17" name="plots"/>' +
                                                                                    'Plot Width : <input  type="text" size="2" value="95" name="p_width"/>' +
                                                                                    'Plots Height : <input  type="text" size="2" value="30" name="p_height"/><br/>' +


                                                                    '</form>' +
                                                                    '<br/>' +
                                                                    '<button type="button"   style="float:right;margin-right:20px;margin-top:10px;" class="design_pipelines_imgSeg_btn runnable">Run</button></span>       <!-- CHANGE IN THIS LINE -->' +
                                                            '</div>' +
                                                            '<div class ="row">' +
                                                                    '<div class ="col-sm-6 col-xs-6 goleft">' +
                                                                            '   <p> </p>' +
    ...
    //=====================================================================================================
    //saved_pipelines_regSeg --- STARTS ----
    //=====================================================================================================

    //clicking execute btn: process the input image and display the output
$(".saved_pipelines_regSeg_btn").live('click', function () {         //<==========================CHANGE HERE
    //alert($(this).siblings(".moduleName").val());
    var $thisButton = $(this);
    $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#FF8C00');
    $thisButton.parent().parent().siblings(".centered").find("span").text('Status: Processing...');
    ...
    $.ajax({
        ...
        cache: false,
        url: "/img_reg",                  //<==========================CHANGE HERE
        data: $(this).siblings(".saved_pipelines_regSeg_form").serialize(),   //<==========================CHANGE HERE
        success: function (option) {
            //alert(option);
            setTimeout(function () {
                $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#00FF00');
...
$(".streamSelector").live("change", function () {
    ...
    //Selecting this tool from left menu: make this papel visible and other panels invisible
$("#saved_pipelines_menu_regSeg_id").click(function () {                     //<====================CHANGE HERE
    $(".img_tools_panel_class").hide();
    ...
    $("#img_processing_screen").append('<div class ="row mt " > <!--CHANGE IN THIS LINE--> ' +
                                               ...
                                               ' <div class ="col-md-4 col-sm-4 mb" style="height:200px;">' +
                                                        ...
                                                        '  <div class ="col-sm-6 col-xs-6 goleft">' +
                                                                ...
                                                                ' <select  id="temp_pipeline_output_select" >' +
                                                                                    ...
                                                                                    '     <option value="static/assets/img_outputs/pipelines/stream5.png" >Pipeline Stream #5</option>' +
                                                                                      '    <option value="static/reg/OUT_IMG_0_1.jpg" >Reference Image</option>' +
                                                                                      '    <option value="static/reg/output/img.png">static/reg/output/1.png</option>' +
                                                                                      '    <option value="static/reg/output/2.png">static/reg/output/2.png</option>' +
                                                                                      '    <option value="static/img/plant_sideview.png">Plant Side View</option>' +
                                                                                    '</select>' +
                                                                ' </p>' +
                                    ...
                                    '  <div class ="col-md-4 col-sm-4 mb">' +
                                                '<div class ="white-panel pn">' +
                                                        '<div class ="white-header" style="background-color:#C0CDDC;">' +
                                                                    ' <h5 style="color:#000000;font-weight:bold;" >Registration+Segmentation</h5>                                             <!-- CHANGE IN THIS LINE -->' +
                                                                    '<span style="color:#000000;font-weight:bold;">' +
                                                                   '<form action="" method="POST" class="saved_pipelines_regSeg_form">                                             <!--CHANGE IN THIS LINE--> ' +
                                                                                    'Input Stream Dir:' +
                                                                                    ' <select  class="moduleName" name="image_location">' +
                                                                                     '    <option value="static/reg/input" selected>static/reg/input/</option>' +
                                                                                    '     <option value="static/reg/output" >static/reg/output</option>' +
                                                                    ...
                                                                    '</form>' +
                                                                    '<br/>' +
                                                                    '<button type="button"   style="float:right;margin-right:20px;margin-top:10px;" class="saved_pipelines_regSeg_btn runnable">Run</button></span>       <!-- CHANGE IN THIS LINE -->' +
                                                            '</div>' +
                                                            '<div class ="row">' +
                                                                    '<div class ="col-sm-6 col-xs-6 goleft">' +
                                                                            '   <p> </p>' +
...
//=====================================================================================================
//design_pipelines_fastqc --- STARTS ----
//=====================================================================================================

//clicking execute btn: process the input image and display the output
$(".design_pipelines_fastqc_btn").live('click', function () {         //<==========================CHANGE HERE
    //alert($(this).siblings(".moduleName").val());
    var $thisButton = $(this);
    $thisButton.parent().parent().siblings(".centered").find("span").css('color', '#FF8C00');
    $thisButton.parent().parent().siblings(".centered").find("span").text('Status: Processing...');
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: "/fastqc_new/",                  //<==========================CHANGE HERE
        data: $(this).siblings(".design_pipelines_fastqc_form").serialize(),   //<==========================CHANGE HERE
        success: function (option) {
            ...
            alert(option.allTasks);

            alert(option.userRegex);

            alert(option.userDir);
...
$(".streamSelector").live("change", function () {
    ...
    //Selecting this tool from left menu: make this papel visible and other panels invisible
$("#design_pipelines_menu_fastqc_id").click(function () {                     //<====================CHANGE HERE
    $(".img_tools_panel_class").hide();
    ...
    $("#img_processing_screen").append('<div class ="row mt " > <!--CHANGE IN THIS LINE--> ' +
                                    ...
                                    '  <div class ="col-md-4 col-sm-4 mb">' +
                                                '<div class ="white-panel pn">' +
                                                        '<div class ="white-header" style="background-color:#C0CDDC;">' +
                                                                    ' <h5 style="color:#000000;font-weight:bold;" >FastQC</h5>                                             <!-- CHANGE IN THIS LINE -->' +
                                                                    '<span style="color:#000000;font-weight:bold;">' +
                                                                   '<form action="" method="POST" class="design_pipelines_fastqc_form">                                             <!--CHANGE IN THIS LINE--> ' +
                                                                                    'Input Dir: <input type="text" name="textDir" id="textDir"> <br/> Regex: <input type="text" name="textRegex" id="textRegex">' +


                                                                    '</form>' +
                                                                    '<br/>' +
                                                                    '<button type="button"   style="float:right;margin-right:20px;margin-top:10px;" class="design_pipelines_fastqc_btn">Run</button></span>       <!-- CHANGE IN THIS LINE -->' +
                                                            '</div>' +
                                                            '<div class ="row">' +
                                                                    '<div class ="col-sm-6 col-xs-6 goleft">' +
                                                                            '   <p> </p>' +
